 ...
 *
 * The rest are SAMPLES covering the domains your resume lists. They exist so you
 * can judge the section with ten items in it. Each has:
 ...
 *
 * Do not simply delete the flag and keep the sample text. An invented endorsement
 * from a person who does not exist is the one thing on a portfolio that cannot be
 * explained away if someone asks to speak to them.
 *
 * Easiest source of real ones: your LinkedIn recommendations. Those are already
 * public, already attributed, and already yours to quote.
 * ---------------------------------------------------------------------------
 */
