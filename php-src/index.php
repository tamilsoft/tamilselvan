                              ...
                              <div class="row">
                                ...
                                <div class="vlt-wp">
                                    ...
                                    <aside class="vlt-wp__aside">
                                        ...
                                        <a class="vlt-wp__all" href="https://www.behance.net/tamilselvan5" target="_blank" rel="noopener">
                                            <span>Explore Case Studies</span>
                                            <span class="vlt-wp__all-icon">&#129146;</span>
                                        </a>
                                    </aside>
                                    <!--Scrolling list-->
                                    <div class="vlt-wp__list">
                                        <?php $workIndex = 0; foreach ($featuredProjects as $slug => $featured) : $workIndex++; ?>
                                        <a class="vlt-wp__card" href="work.php?p=<?php echo urlencode($slug); ?>">
                                            ...
                                            <div class="vlt-wp__media">
                                                ...
                                                <span class="vlt-wp__media-arrow" aria-hidden="true">&#129146;</span>
                                            </div>
                                            <div class="vlt-wp__info">
                                                ...
                                                <span class="vlt-wp__btn"><?php echo htmlspecialchars($featured['cta'] ?? 'View Case Study', ENT_QUOTES, 'UTF-8'); ?> <span class="vlt-wp__btn-icon">&#129146;</span></span>
                                            </div>
                                        </a>
                                        <?php endforeach; ?>
                                    </div>
